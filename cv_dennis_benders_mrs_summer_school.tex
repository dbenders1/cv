...
\ecvworkexperience{2021 -- Present}{PhD Cognitive Robotics}{Delft University of Technology, Delft}{\textit{Research topic:} Safe Model Predictive Control (MPC) on drones\newline\textit{Ancilliary activities:} Department PhD representative, supervisor of bachelor and master students, mentor of master robotics students\newline\textit{Topics of interest:} MPC, software engineering, sustainability}{}
